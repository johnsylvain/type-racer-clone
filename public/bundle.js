...
/***/ function(module, exports, __webpack_require__) {
	...
	var _superagent = __webpack_require__(/*! superagent */ 55);
	
	var _superagent2 = _interopRequireDefault(_superagent);
	
	__webpack_require__(/*! ./style.scss */ 61);
	
	var _Phrase = __webpack_require__(/*! ./Phrase */ 65);
	
	var _Phrase2 = _interopRequireDefault(_Phrase);
	
	var _Player = __webpack_require__(/*! ./Player */ 66);
	...
	var Race = function () {
		function Race() {
			...
			this.me = this.players.filter(function (p) {
				return p.id === _this.socket.id;
			})[0];
	
			this.players.forEach(function (player) {
				_this.drawPlayer(player);
			});
	
			this.setUpEvents();
			this.setUpSockets();
	
			_superagent2.default.get('http://localhost:3000/api/phrase').end(function (err, data) {
				_this.phrase = new _Phrase2.default(data.body.data);
				_this.drawPhrase();
			});
		}
		...
		_createClass(Race, [{
			...
			value: function setUpEvents() {
				...
				this.inputElem.addEventListener('input', function (e) {
					_this2.checkInput(e.target.value);
				});
			}
		}, {
			key: 'setUpSockets',
			value: function setUpSockets() {
				...
				this.socket.on('player join', function (data) {
					_this3.players = data.users;
					_this3.playersMap = _this3.players.reduce(function (obj, player) {
						obj[player.id] = player;
						return obj;
					}, {});
					_this3.raceTrackElem.innerHTML = '';
					data.users.forEach(function (user) {
						_this3.drawPlayer(user);
					});
				});
	
				this.socket.on('player disconnect', function (data) {
					_this3.removePlayer(data);
				});
	
				this.socket.on('move player', function (data) {
					_this3.movePlayer(data);
				});
			}
		}, {
			key: 'drawPhrase',
			value: function drawPhrase() {
				var _this4 = this;
	
				this.textElem.innerHTML = '';
	
				var words = this.phrase.words;
	
				words.forEach(function (word, i) {
					var span = document.createElement('span');
					span.innerHTML = word + ' ';
					span.classList.remove('current');
					if (i === _this4.phrase.pointer) span.classList.add('current');
					_this4.textElem.appendChild(span);
				});
			}
		}, {
			key: 'drawPlayer',
			value: function drawPlayer(data) {
				var id = data.id,
				    colorString = data.colorString,
				    pointer = data.pointer;
	
				var player = new _Player2.default(id, colorString);
			...
			value: function removePlayer(data) {
				...
				var target = document.getElementById(player.id);
			...
			value: function movePlayer(data) {
				...
				this.drawPhrase();
				var target = this.playersMap[data.user].id;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var json = __webpack_require__(/*! json3 */ 12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./lib/index */ 21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transports = __webpack_require__(/*! ./transports/index */ 23);
	var Emitter = __webpack_require__(/*! component-emitter */ 38);
	...
	Socket.transports = __webpack_require__(/*! ./transports/index */ 23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(/*! emitter */ 38);
	var RequestBase = __webpack_require__(/*! ./request-base */ 56);
	var isObject = __webpack_require__(/*! ./is-object */ 57);
	var isFunction = __webpack_require__(/*! ./is-function */ 58);
	var ResponseBase = __webpack_require__(/*! ./response-base */ 59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../~/css-loader!./../~/sass-loader!./style.scss */ 62);
...
/***/ function(module, exports) {
	...
	var Player = function () {
		function Player(id, colorString) {
