...
/***/ function(module, exports, __webpack_require__) {
	...
	var controller = {
		init: function init() {
			var randomPhrase = model.text[Math.floor(Math.random() * model.text.length)];
		...
		getArrayOfWords: function getArrayOfWords() {
		...
		checkInput: function checkInput(value) {
			if (value) return value === model.phrase.currentWord.substring(0, value.length);
		},
		movePointer: function movePointer(value) {
	...
	var trackView = {
		init: function init() {
			...
			this.players.forEach(function (player) {
				...
				_this.raceTrackElem.appendChild(lane);
			});
		...
		render: function render() {
			...
			var pointer = controller.getPointer();
			var wordCount = controller.getArrayOfWords().length;
